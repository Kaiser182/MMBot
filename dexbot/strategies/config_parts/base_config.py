    ...
    def configure(cls, return_base_config=True):
        ...
        base_config = [
            ConfigElement('account', 'string', '', 'Account',
                          ...
                          ''),
            ConfigElement('market', 'string', 'BIR/USD', 'Market',
                          'BitShares market to operate on, in the format QUOTE/BASE, for example \"BIR/USD\"',
                          r'[A-Z0-9\.]+[:\/][A-Z0-9\.]+'),
            ConfigElement('fee_asset', 'string', 'BIR', 'Fee asset',
